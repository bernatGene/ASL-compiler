...
public:
  ...
  virtual void enterFuncall(AslParser::FuncallContext *ctx) = 0;
  virtual void exitFuncall(AslParser::FuncallContext *ctx) = 0;

  virtual void enterCall_parameters(AslParser::Call_parametersContext *ctx) = 0;
  virtual void exitCall_parameters(AslParser::Call_parametersContext *ctx) = 0;
  ...
  virtual void enterFunCallStmt(AslParser::FunCallStmtContext *ctx) = 0;
  virtual void exitFunCallStmt(AslParser::FunCallStmtContext *ctx) = 0;
  ...
  virtual void enterExprFuncall(AslParser::ExprFuncallContext *ctx) = 0;
  virtual void exitExprFuncall(AslParser::ExprFuncallContext *ctx) = 0;

  virtual void enterExprAAccess(AslParser::ExprAAccessContext *ctx) = 0;
  virtual void exitExprAAccess(AslParser::ExprAAccessContext *ctx) = 0;

  virtual void enterArray_access(AslParser::Array_accessContext *ctx) = 0;
  virtual void exitArray_access(AslParser::Array_accessContext *ctx) = 0;
