...
public:
  ...
  void enterFunCallStmt(AslParser::FunCallStmtContext *ctx);
  void exitFunCallStmt(AslParser::FunCallStmtContext *ctx);
  ...
  void enterFuncall(AslParser::FuncallContext *ctx);
  void exitFuncall(AslParser::FuncallContext *ctx);

  void enterExprFuncall(AslParser::ExprFuncallContext *ctx);
  void exitExprFuncall(AslParser::ExprFuncallContext *ctx);

  void enterExprIdent(AslParser::ExprIdentContext *ctx);
  void exitExprIdent(AslParser::ExprIdentContext *ctx);

  void enterExprAAccess(AslParser::ExprAAccessContext *ctx);
  void exitExprAAccess(AslParser::ExprAAccessContext *ctx);
